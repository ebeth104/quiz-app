...
public class QuestionService implements IQuestionService {
    ...
    public Question updateQuestion(Long id, Question question) throws ChangeSetPersister.NotFoundException {
        ...
        if (theQuestion.isPresent())
        {
            ...
            updatedQuestion.setChoice(question.getChoice());
    ...
    @Override
    public List<Question> getQuestionsForUser(Integer numQ, String category)
    {
        Pageable pageable = PageRequest.of(0, numQ);
        return questionRepository.findByCategory(category, pageable).getContent();
    }
}
