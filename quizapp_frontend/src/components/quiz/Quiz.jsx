...
const Quiz = () => {
	...
	const { selectedCategory, selectedNumQuestions } = location.state
	...
	const fetchQuizData = async () => {
		if (selectedNumQuestions && selectedCategory) {
			const questions = await fetchQuizForUser(selectedNumQuestions, selectedCategory)
